...
const ko: Translations = {
  ...
  whitelistPlaceholder: '@아이디를 한 줄에 하나씩 입력 (Ctrl/⌘+Enter로 추가)',
  add: '추가',
  developer: '개발자',
  debugMode: '디버그 모드',
...
const en: Translations = {
  ...
  whitelistPlaceholder: 'Enter @usernames, one per line (Ctrl/⌘+Enter to add)',
  add: 'Add',
  developer: 'Developer',
...
const ja: Translations = {
  ...
  whitelistPlaceholder: '@ユーザーIDを1行に1つずつ入力 (Ctrl/⌘+Enterで追加)',
  add: '追加',
  developer: '開発者',
  debugMode: 'デバッグモード',
