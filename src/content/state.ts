...
export function getProtectedKeywords(): string[] { return _protectedKeywords; }
export function setProtectedKeywords(keywords: string[]): void { _protectedKeywords = keywords; }
